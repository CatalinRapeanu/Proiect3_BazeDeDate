...
if(isset($_POST['submit'])){ 
    ...
    foreach($data->cont as $cont)
    {
        if($cont->id == $id)
        {
            ...
            $cont->user_type = $_POST['usertype'];
        }
    }
        
    $handle = fopen("./xml/conturi.xml", "wb");
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    ...
                    $id = $_GET['id'];
                    $data = simplexml_load_file('./xml/conturi.xml');
                    foreach($data->cont as $doc){
                        if($doc->id == $id){
                    ?>                           
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        <input type="hidden" name="id" value="<?php echo $doc->id; ?>">
                        Utilizator:
                        <input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="username" value="<?php echo $doc->username; ?>"><br>
                        Parola:
                        <input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="password" value="<?php echo $doc->password; ?>"><br>
                        Tipul de utilizator: 
                        <br> <input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="usertype" value="<?php echo $doc->user_type; ?>"><br>
