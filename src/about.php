...
<html lang="en">
    ...
    <body> 
        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-black">
                <h4 class="display-4 fw-bolder">Noul nostru logo</h4>
                <a href="./xml/mathml.xml">LOGO</a><br/><br/>
            </div>
        </div>

        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-black">
                <h4 class="display-4 fw-bolder">Ne puteti lasa recenzii aici</h4>
                <a href="./xml/link.xml">Lasa o recenzie</a><br/><br/>
            </div>
        </div>
