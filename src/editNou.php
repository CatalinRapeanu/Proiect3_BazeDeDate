            ...
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    ...
                    ?>
                        ...
                        Utilizator:
                        <input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="username" value="<?php echo $cont->username; ?>"><br>  
                        Parola:
                        <input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="password" value="<?php echo $cont->password; ?>"><br> 
                        Tipul de utilizator: 
                        <br> <input class="form-control" style="width: 50%; margin-left: auto; margin-right: auto;" type="text" name="usertype" value="<?php echo $cont->user_type; ?>"><br>
